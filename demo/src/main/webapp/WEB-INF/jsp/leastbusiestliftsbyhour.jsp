...
<head>
    ...
    <title>List Top Five Least Busiest Lifts by Hour on a Ski Day</title>
</head>
<body>

<div class="container theme-showcase" role="main">
    <form action="/leastbusiestliftsbyhour" method="get">
        <div class="jumbotron">
            <div id="welcome"><a href="/">Home</a></div>
            <h2>List Hourly Top Five Least Busiest Lifts On a Ski Day</h2>
        </div>
        <p>
            <select name="hour">
    ...
    <h3>Found top five least busiest lifts at hour{${hour}}:</h3>
